    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='支付方式', default=3, choices=[(3, '支付宝'), (4, '银联支付'), (2, '微信支付'), (1, '货到付款')])),
                ...
                ('order_status', models.SmallIntegerField(verbose_name='订单状态', default=1, choices=[(1, '待支付'), (4, '待评价'), (3, '待收货'), (2, '待发货'), (5, '已完成')])),
